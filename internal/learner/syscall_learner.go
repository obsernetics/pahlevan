...
const (
	// Learning phases for container behavior analysis
	PhaseInitializing     LearningPhase = "Initializing"     // Initial setup and preparation phase
	...
	PhaseProfileGenerated LearningPhase = "ProfileGenerated" // Profile has been generated
